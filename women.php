...
<body>
    ...
    <div class="gambar">
        ...
        <div class="product-info1">
            ...
            <p>Tank top Wanita dengan fit yang diperbarui sehingga pas dikenakan. Desain henley neck yang cocok untuk berbagai outfit.</p>
            <button type="submit" name="buy_now" onclick="openModal('Croptop')">Beli Sekarang</button>
    </div>
        </div>
        </div>
